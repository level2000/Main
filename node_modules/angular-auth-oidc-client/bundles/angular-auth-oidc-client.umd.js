(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('@angular/common'), require('rxjs/Observable'), require('rxjs/BehaviorSubject'), require('@angular/router'), require('jsrsasign'), require('rxjs/observable/timer')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common/http', '@angular/common', 'rxjs/Observable', 'rxjs/BehaviorSubject', '@angular/router', 'jsrsasign', 'rxjs/observable/timer'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.angularAuthOidcClient = global.ng.angularAuthOidcClient || {}),global.ng.core,global.ng.http,global.ng.common,global.Rx,global.Rx,global.ng.router,global.jsrsasign,global.Rx.Observable.prototype));
}(this, (function (exports,_angular_core,_angular_common_http,_angular_common,rxjs_Observable,rxjs_BehaviorSubject,_angular_router,jsrsasign,rxjs_observable_timer) { 'use strict';
...
var OidcSecurityValidation = /** @class */ (function () {
    ...
    OidcSecurityValidation.prototype.validate_id_token_aud = function (dataIdToken, aud) {
        if (dataIdToken.aud instanceof Array) {
            var /** @type {?} */ result = this.arraysEqual(dataIdToken.aud, aud);
            if (!result) {
     ...
     * @return {?}
     */
    OidcSecurityValidation.prototype.arraysEqual = function (arr1, arr2) {
...
var AuthWellKnownEndpoints = /** @class */ (function () {
    ...
    function AuthWellKnownEndpoints(http, authConfiguration, oidcSecurityCommon) {
        ...
        this.getWellKnownEndpoints = function () {
            ...
            var /** @type {?} */ url = _this.authConfiguration.stsServer +
    ...
    AuthWellKnownEndpoints.prototype.setupModule = function () {
        ...
        if (data) {
            ...
            this.getWellKnownEndpoints().subscribe(function (dataFromServer) {
                _this.setWellKnownEndpoints(dataFromServer);
                _this.oidcSecurityCommon.wellKnownEndpoints = dataFromServer;
                _this.oidcSecurityCommon.logDebug(dataFromServer);
...
var OidcSecurityCheckSession = /** @class */ (function () {
    ...
    OidcSecurityCheckSession.prototype.pollServerSession = function (clientId) {
        var _this = this;
        var /** @type {?} */ source = rxjs_observable_timer.timer(3000, 3000).pipe(timeInterval(), pluck('interval'), take(10000));
        source.subscribe(function () {
            if (_this.sessionIframe && clientId) {
                ...
                _this.oidcSecurityCommon.logWarning('OidcSecurityCheckSession pollServerSession sessionIframe does not exist');
                _this.oidcSecurityCommon.logDebug(clientId);
                _this.oidcSecurityCommon.logDebug(_this.sessionIframe);
                // this.init();
            }
        }, function (err) {
...
var StateValidationService = /** @class */ (function () {
     ...
     * @param {?} authWellKnownEndpoints
     */
    function StateValidationService(authConfiguration, oidcSecurityCommon, authWellKnownEndpoints) {
        this.authConfiguration = authConfiguration;
        this.oidcSecurityCommon = oidcSecurityCommon;
        this.authWellKnownEndpoints = authWellKnownEndpoints;
     ...
     * @return {?}
     */
    StateValidationService.prototype.successful_validation = function () {
...
var OidcSecurityService = /** @class */ (function () {
     ...
     * @param {?} authWellKnownEndpoints
     */
    function OidcSecurityService(platformId, http, stateValidationService, authConfiguration, router, oidcSecurityCheckSession, oidcSecuritySilentRenew, oidcSecurityUserService, oidcSecurityCommon, authWellKnownEndpoints) {
        ...
        if (_angular_common.isPlatformBrowser(this.platformId)) {
            ...
            this.authWellKnownEndpoints.onWellKnownEndpointsLoaded.subscribe(function () {
                ...
                if (_this.authConfiguration.start_checksession &&
                    !_this.oidcSecurityCheckSession.doesSessionExist()) {
        ...
        this.getSigningKeys().subscribe(function (jwtKeys) {
            ...
            if (validationResult.authResponseIsValid) {
                ...
                if (_this.authConfiguration.auto_userinfo) {
                    ...
                    _this.oidcSecurityUserService.userData = validationResult.decoded_id_token;
    ...
    OidcSecurityService.prototype.runTokenValidation = function () {
        ...
        var /** @type {?} */ source = rxjs_observable_timer.timer(5000, 3000).pipe(timeInterval(), pluck('interval'), take(10000));
        source.subscribe(function () {
            if (_this._userData.value) {
                if (_this.oidcSecurityValidation.isTokenExpired(_this.oidcSecurityCommon.idToken, _this.authConfiguration
                    .silent_renew_offset_in_seconds)) {
...
exports.ɵa = StateValidationService;
